...
require_roles(['local authority','authority']); // support both
...
/**
 * Support BOTH:
 *   view_issue.php?issue_id=123   (your current)
 *   view_issue.php?id=123        (common)
 */
...
/** Authority area restriction (authority user has area_id) */
...
/** Active field workers list (B2 = any active worker, no area filter) */
$st = $pdo->prepare("
...
/** Current assignment (if any active) to show "already assigned" */
$st = $pdo->prepare("
...
<div class="container py-4 app-container">
  ...
  <div class="card-dark p-3 p-md-4">
    ...
    <!-- Photos + description + proof placeholders -->
    <div class="row g-3">
      ...
      <div class="col-12 col-lg-5">
        ...
        <!-- STRICT LOW-FI: placeholders only (no upload feature) -->
