...
if ($areaId <= 0) {
  ...
  echo "<div class='container py-4 app-container'>
          ...
          <a class='btn btn-outline-light btn-sm mt-3' href='" . BASE_URL . "/worker/community.php'>← Back to Community</a>
        </div>";
...
WHERE i.area_id = ?
  AND a.assignment_status IN ('COMPLETED','DONE','ACCEPTED','ASSIGNED','IN_PROGRESS','CLOSED') /* safe extra statuses */
...
<div class="container py-4 app-container">
  <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3 mb-4">
    ...
    <a class="btn btn-outline-light btn-sm" href="<?= BASE_URL ?>/worker/community.php">← Back to Community</a>
  </div>
