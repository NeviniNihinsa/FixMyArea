...
<div class="container py-4 app-container">
  ...
  <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 mb-3">
    ...
    <div class="d-flex gap-2">
      ...
      <?php endif; ?>
      <a class="btn btn-brand btn-sm" href="<?= BASE_URL ?>/citizen/home.php">Back to Home</a>
    </div>
  </div>
          ...
          <?php foreach ($rows as $n): ?>
            <?php
              ...
              if ($actionUrl === '' && !empty($n['issue_id'])) {
                  // fallback: open issue view
                  $actionUrl = BASE_URL . "/citizen/issue_view.php?issue_id=" . (int)$n['issue_id'];
              } elseif ($actionUrl !== '' && str_starts_with($actionUrl, '/')) {
                  // if stored like "/citizen/issue_view.php?issue_id=1"
